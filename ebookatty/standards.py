...
ALL_TAGS = set(SC_FIELDS_NOT_COPIED + SC_FIELDS_COPY_NOT_NULL + SOCIAL_METADATA_FIELDS + DEVICE_METADATA_FIELDS + PUBLICATION_METADATA_FIELDS + OPF_PARENT_TAGS + META_TAGS + list(EXTH_Types.values()) + list(id_map_hexstrings.values()) + list(id_map_strings.values()) + list(id_map_values.values()))
